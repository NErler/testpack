#' testpack: Joint Analysis and Imputation of Incomplete Data
#'
#' The \strong{testpack} package performs simultaneous imputation and inference
...
#' \strong{testpack} provides the following main functions that facilitate
...
#' \code{\link[testpack:summary.testpack]{summary()}},
#' \code{\link[testpack:summary.testpack]{coef()}} and
#' \code{\link[testpack:summary.testpack]{confint()}} are available, and
#' results can be visualized with the help of
#' \code{\link[testpack:traceplot]{traceplot()}} or
#' \code{\link[testpack:densplot]{densplot()}}.
#'
#' The function \code{\link[testpack:predict.testpack]{predict()}} allows
#' prediction (including credible intervals) from \code{testpack} models.
#'
#'
...
#' \code{\link[testpack:get_MIdat]{get_MIdat()}}.
#' The function \code{\link[testpack:plot_imp_distr]{plot_imp_distr()}} allows
...
#' \itemize{
#' \item \href{https://nerler.github.io/testpack/articles/MinimalExample.html}{\emph{Minimal Example}}:\cr
#' A minimal example demonstrating the use of
#'                            \code{\link{lm_imp}},
#'                            \code{\link{summary.testpack}},
#'                            \code{\link{traceplot}}
#'                            and \code{\link{densplot}}.
#' \item \href{https://nerler.github.io/testpack/articles/VisualizingIncompleteData.html}{\emph{Visualizing Incomplete Data}}:\cr
...
#'
#' \item \href{https://nerler.github.io/testpack/articles/ModelSpecification.html}{\emph{Model Specification}}:\cr
...
#'
#' \item \href{https://nerler.github.io/testpack/articles/SelectingParameters.html}{\emph{Parameter Selection}}:\cr
...
#'
#' \item \href{https://nerler.github.io/testpack/articles/MCMCsettings.html}{\emph{MCMC Settings}}:\cr
...
#'        \code{inits}.
#'
#' \item \href{https://nerler.github.io/testpack/articles/AfterFitting.html}{\emph{After Fitting}}:\cr
...
#'       \code{\link{get_MIdat}}.
#'
#' \item \href{https://nerler.github.io/testpack/articles/TheoreticalBackground.html}{\emph{Theoretical Background}}:\cr
#'       Explanation of the statistical method implemented in \strong{testpack}.
#'}
#' @references
...
.onAttach <- function(libname, pkgname) {
  packageStartupMessage(
    "Please report any bugs to the package maintainer (https://github.com/NErler/testpack/issues)."
  )
}
...
#' Parameters used by several functions in testpack
...
#'             given directly by \strong{testpack}.)
