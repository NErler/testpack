#' Continue sampling from an object of class testpack
#'
#' This function continues the sampling from the MCMC chains of an existing
#' object of class 'testpack'.\cr
...
#'                       \code{\link[testpack:model_imp]{*_imp}} and the vignette
...
add_samples <- function(object, n.iter, add = TRUE, thin = NULL,
  ...
  # add/set new argument values n.iter and thin to/in testpack object
  ...
  # add computational time to testpack object
