...
#' @name traceplot
#'
#' @seealso \code{\link{summary.testpack}},
...
#' @rdname traceplot
#' @export
traceplot.testpack <- function(object, start = NULL, end = NULL, thin = NULL,
...
#' Plot the posterior density from object of class testpack
#'
#' The function plots a set of densities (per chain and coefficient) from
#' the MCMC sample of an object of class "testpack".
...
#' @rdname densplot
#' @export
densplot.testpack <- function(object, start = NULL, end = NULL, thin = NULL,
                             subset = c(analysis_main = TRUE),
...
get_plotmain <- function(object, plotnams, ylab = FALSE) {
  ...
  # sub-plots
  # - object: an object of class testpack
  ...
  # get the list of coefficient names from the testpack object
...
#'
#' @seealso Vignette: \href{https://nerler.github.io/testpack/articles/VisualizingIncompleteData.html}{Visualizing Incomplete Data}
#'
#' @examples
