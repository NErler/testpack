...
#'              created by \strong{testpack}, initial values are then generated
#'              by JAGS.
...
#'                [Model Specification](https://nerler.github.io/testpack/articles/ModelSpecification.html#auxvars)
...
#'              \href{https://nerler.github.io/testpack/articles/ModelSpecification.html#functions-with-restricted-support}{ModelSpecification})
...
#' @name model_imp
#'
#' @return An object of class \link[=testpackObject]{testpack}.
#'
#'
#'
...
#' I.e., a formula `y ~ .` is valid in **testpack**.
#'
#'
...
#' \href{https://nerler.github.io/testpack/articles/SelectingParameters.html}{Parameter Selection}\cr
#'
...
#'
#' #### Contrasts
#' **testpack** version \mjeqn{\geq}{ascii} 1.0.0 uses the globally (via
...
#' \strong{testpack} handles non-linear effects, transformation of covariates
...
#'          \code{\link{summary.testpack}}, \code{\link{MC_error}},
#'          \code{\link{GR_crit}},
#'          \code{\link{predict.testpack}}, \code{\link{add_samples}},
#'          \code{\link{testpackObject}}, \code{\link{add_samples}},
#'          \code{\link{parameters}}, \code{\link{list_models}}
#'
#' Vignettes
#' * \href{https://nerler.github.io/testpack/articles/MinimalExample.html}{Minimal Example}
#' * \href{https://nerler.github.io/testpack/articles/ModelSpecification.html}{Model Specification}
#' * \href{https://nerler.github.io/testpack/articles/SelectingParameters.html}{Parameter Selection}
#' * \href{https://nerler.github.io/testpack/articles/MCMCsettings.html}{MCMC Settings}
#' * \href{https://nerler.github.io/testpack/articles/AfterFitting.html}{After Fitting}
#'
#'
#'
#' @examples
  ...
  object <- structure(
    list(analysis_type = analysis_type,
         ...
         comp_info = list(start_time = t0,
                          duration = t1 - t0,
                          testpack_version = packageVersion("testpack"),
